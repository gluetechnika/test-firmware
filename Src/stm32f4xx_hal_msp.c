...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PH5     ------> I2C2_SDA 
    */
    HAL_GPIO_DeInit(GPIOH, CTP_SCL_Pin|CTP_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI 
    */
    HAL_GPIO_DeInit(GPIOE, LTC_SCK_Pin|LTC_MISO_Pin|LTC_MOSI_Pin);
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PC7     ------> TIM3_CH2 
    */
    GPIO_InitStruct.Pin = ENCODER3_B_Pin|ENCODER3_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC7     ------> TIM3_CH2 
    */
    HAL_GPIO_DeInit(GPIOC, ENCODER3_B_Pin|ENCODER3_A_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2 
    */
    HAL_GPIO_DeInit(GPIOD, ENCODER4_B_Pin|ENCODER4_A_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PI6     ------> TIM8_CH2 
    */
    HAL_GPIO_DeInit(GPIOI, ENCODER1_B_Pin|ENCODER1_A_Pin);
